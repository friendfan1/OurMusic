...
#include "../../musicplayer/lyricwidget.h"
...
QT_MOC_LITERAL(1, 12, 9), // "showLyric"
QT_MOC_LITERAL(2, 22, 0) // ""

    },
    "LyricWidget\0showLyric\0"
};
...
void LyricWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->showLyric((*reinterpret_cast< qint64(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObject LyricWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_LyricWidget.data,
...
void *LyricWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_LyricWidget.stringdata0))
        return static_cast<void*>(const_cast< LyricWidget*>(this));
